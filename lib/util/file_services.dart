...
class FileServiceUtil { 
  ...
  static Future<String> fileUploadMultipart({ 
    ...
    final httpClient = HttpClient() 
      ..connectionTimeout = const Duration(seconds: 10);   final request = await httpClient.postUrl( 
      Uri.parse(url!), 
    ); 
    ...
    await request.addStream(streamUpload);   final httpResponse = await request.close(); 
// 
